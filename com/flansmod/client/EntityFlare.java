...
public class EntityFlare extends EntityFX {
   ...
   public void func_70071_h_() {
      ...
      for(int i = 0; i < NUM; ++i) {
         ...
         FlansMod.proxy.spawnParticle("flansmod.fmflame", this.field_70169_q + dx * (double)i, this.field_70167_r + dy * (double)i, this.field_70166_s + dz * (double)i, 0.0D, 0.0D, 0.0D);
      }
