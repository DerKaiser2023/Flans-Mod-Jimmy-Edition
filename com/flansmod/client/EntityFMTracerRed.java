...
public class EntityFMTracerRed extends EntityFX {
   ...
   public EntityFMTracerRed(World w, double px, double py, double pz, double mx, double my, double mz) {
      ...
      FlansMod.proxy.spawnParticle("flansmod.FMTracerRed", this.field_70165_t, this.field_70163_u, this.field_70161_v, 0.0D, 0.0D, 0.0D);
   ...
   public void func_70539_a(Tessellator par1Tessellator, float par2, float par3, float par4, float par5, float par6, float par7) {
      ...
      FMLClientHandler.instance().getClient().field_71446_o.func_110577_a(new ResourceLocation("flansmod", "particle/FMTracerRed.png"));
