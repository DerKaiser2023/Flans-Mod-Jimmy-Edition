...
public class EntitytankDeath extends EntityFX {
   public static ResourceLocation icon = new ResourceLocation("flansmod", "particle/FMFlame.png");

   public EntitytankDeath(World w, double px, double py, double pz, double mx, double my, double mz) {
   ...
   public void func_70539_a(Tessellator par1Tessellator, float par2, float par3, float par4, float par5, float par6, float par7) {
      ...
      float scale = 0.1F + (float)this.field_70546_d * 12.0F - (float)(this.field_70546_d * this.field_70546_d) * 1.5F;
      ...
      par1Tessellator.func_78369_a(this.field_70552_h * colorIntensity, this.field_70553_i * 0.0F, this.field_70551_j * 0.0F, 1.0F - (float)(this.field_70546_d * this.field_70546_d * this.field_70546_d) * 9.0E-4F);
