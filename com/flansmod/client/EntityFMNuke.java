...
public class EntityFMNuke extends EntityFX {
   ...
   public EntityFMNuke(World w, double px, double py, double pz, double mx, double my, double mz) {
   ...
   public void func_70539_a(Tessellator par1Tessellator, float par2, float par3, float par4, float par5, float par6, float par7) {
      ...
      float scale = 40.6F - (float)this.field_70546_d * 15.0F;
      ...
      par1Tessellator.func_78369_a(this.field_70552_h * colorIntensity, this.field_70553_i * (colorIntensity - (float)this.field_70546_d * 0.05F), this.field_70551_j * (colorIntensity - (float)this.field_70546_d * 0.05F), 1.0F - (float)this.field_70546_d * 0.005F);
