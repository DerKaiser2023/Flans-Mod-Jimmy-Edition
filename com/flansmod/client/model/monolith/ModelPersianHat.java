...
public class ModelPersianHat extends ModelCustomArmour {
   ...
   private void initheadModel_1() {
      ...
      this.headModel[6] = new ModelRendererTurbo(this, 1, 33, this.textureX, this.textureY);
      this.headModel[7] = new ModelRendererTurbo(this, 1, 1, this.textureX, this.textureY);
      this.headModel[8] = new ModelRendererTurbo(this, 33, 1, this.textureX, this.textureY);
      this.headModel[9] = new ModelRendererTurbo(this, 33, 33, this.textureX, this.textureY);
      this.headModel[10] = new ModelRendererTurbo(this, 41, 1, this.textureX, this.textureY);
      this.headModel[11] = new ModelRendererTurbo(this, 73, 1, this.textureX, this.textureY);
      this.headModel[12] = new ModelRendererTurbo(this, 65, 33, this.textureX, this.textureY);
      this.headModel[13] = new ModelRendererTurbo(this, 97, 33, this.textureX, this.textureY);
      this.headModel[14] = new ModelRendererTurbo(this, 33, 41, this.textureX, this.textureY);
      this.headModel[15] = new ModelRendererTurbo(this, 57, 41, this.textureX, this.textureY);
      this.headModel[16] = new ModelRendererTurbo(this, 81, 41, this.textureX, this.textureY);
      this.headModel[17] = new ModelRendererTurbo(this, 105, 41, this.textureX, this.textureY);
      this.headModel[18] = new ModelRendererTurbo(this, 33, 33, this.textureX, this.textureY);
