...
public class ModelArabeArmor extends ModelCustomArmour {
   ...
   private void initbodyModel_1() {
      ...
      this.bodyModel[2] = new ModelRendererTurbo(this, 49, 17, this.textureX, this.textureY);
   ...
   private void initleftArmModel_1() {
      ...
      this.leftArmModel[1] = new ModelRendererTurbo(this, 25, 17, this.textureX, this.textureY);
      this.leftArmModel[2] = new ModelRendererTurbo(this, 1, 1, this.textureX, this.textureY);
   ...
   private void initrightArmModel_1() {
      ...
      this.rightArmModel[1] = new ModelRendererTurbo(this, 97, 9, this.textureX, this.textureY);
      this.rightArmModel[2] = new ModelRendererTurbo(this, 1, 1, this.textureX, this.textureY);
   ...
   private void initleftLegModel_1() {
      ...
      this.leftLegModel[1] = new ModelRendererTurbo(this, 17, 33, this.textureX, this.textureY);
   ...
   private void initrightLegModel_1() {
      ...
      this.rightLegModel[1] = new ModelRendererTurbo(this, 1, 25, this.textureX, this.textureY);
