...
public class ModelBascinet extends ModelCustomArmour {
   ...
   public ModelBascinet() {
      ...
      this.headModel[7] = new ModelRendererTurbo(this, 65, 1, this.textureX, this.textureY);
      this.headModel[8] = new ModelRendererTurbo(this, 105, 1, this.textureX, this.textureY);
      this.headModel[9] = new ModelRendererTurbo(this, 73, 17, this.textureX, this.textureY);
      this.headModel[10] = new ModelRendererTurbo(this, 25, 9, this.textureX, this.textureY);
      this.headModel[11] = new ModelRendererTurbo(this, 65, 9, this.textureX, this.textureY);
      this.headModel[12] = new ModelRendererTurbo(this, 41, 17, this.textureX, this.textureY);
      this.headModel[13] = new ModelRendererTurbo(this, 105, 9, this.textureX, this.textureY);
      this.headModel[14] = new ModelRendererTurbo(this, 105, 17, this.textureX, this.textureY);
      this.headModel[15] = new ModelRendererTurbo(this, 113, 17, this.textureX, this.textureY);
      this.headModel[16] = new ModelRendererTurbo(this, 1, 25, this.textureX, this.textureY);
      this.headModel[17] = new ModelRendererTurbo(this, 121, 17, this.textureX, this.textureY);
