...
public class GametypeZombies extends Gametype {
   ...
   public void zombifySomeone() {
      if (teamsManager.currentRound.teams[0].members.size() > 0) {
         EntityPlayer zombifiedPlayer = teamsManager.getPlayer((String)teamsManager.currentRound.teams[0].members.get(rand.nextInt(teamsManager.currentRound.teams[0].members.size())));
         TeamsManager var10000 = teamsManager;
