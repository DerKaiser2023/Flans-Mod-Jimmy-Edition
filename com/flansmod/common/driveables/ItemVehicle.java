...
public class ItemVehicle extends ItemMapBase implements IPaintableItem {
      ...
      if (movingobjectposition == null) {
         ...
         if (movingobjectposition.field_72313_a == MovingObjectType.BLOCK) {
            ...
            if (this.type.placeableOnLand || block instanceof BlockLiquid) {
               if (!world.field_72995_K) {
                  world.func_72838_d(new EntityVehicle(world, (double)i + 0.5D, (double)j + 2.5D, (double)k + 0.5D, entityplayer, this.type, this.getData(itemstack, world)));
               }
   ...
   public Entity spawnVehicle(World world, double x, double y, double z, ItemStack stack) {
      Entity entity = new EntityVehicle(world, x, y, z, this.type, this.getData(stack, world));
      if (!world.field_72995_K) {
